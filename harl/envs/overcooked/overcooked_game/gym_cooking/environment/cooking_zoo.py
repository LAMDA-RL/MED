...
from harl.envs.overcooked.overcooked_game.gym_cooking.cooking_book.recipe_drawer import (
    NUM_GOALS,
    RECIPES,
)
from harl.envs.overcooked.overcooked_game.gym_cooking.cooking_world.abstract_classes import *
from harl.envs.overcooked.overcooked_game.gym_cooking.cooking_world.cooking_world import (
    CookingWorld,
)
from harl.envs.overcooked.overcooked_game.gym_cooking.cooking_world.world_objects import *
...
class CookingEnvironment(AECEnv):
    ...
    def __init__(
        ...
        if "dense" in self.obs_spaces:
            ...
            self.observation_spaces_inside = {
        ...
        self.is_init_reset = True

    def action_space(self, agent):
        return self.action_spaces_inside[agent]

    def observation_space(self, agent):
        return self.observation_spaces_inside[agent]
    ...
    def reset(self, seed=None, options=None):
        if self.is_init_reset:
            self.world = CookingWorld(seed=seed)
            self.is_init_reset = False
        else:
            self.world = CookingWorld()
        ...
        if "dense" in self.obs_spaces:
            ...
            if held_obj is not None:
                ...
                if isinstance(held_obj, Food):
                    holding_state_feat[
                        FOOD_CLASSES_IDX[held_obj_name]
                    ] = held_obj.done()
